...
namespace GameCore.Data
{
    ...
    public class SceneDataSO : ScriptableObject
    {
        ...
        public void LoadScene()
        {
            ...
            var sceneManager = Managers.SceneManager.Instance;

            // 페이드 지속 시간 설정
            if (SceneTransition.Instance != null)
            {
                SceneTransition.Instance.FadeDuration = _fadeDuration;
            }

            // 메인 씬 로드
            sceneManager.LoadLoading(this);
        }
